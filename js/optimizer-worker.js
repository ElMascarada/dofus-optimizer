...
self.addEventListener('message', (event) => {
  ...
  try {
    ...
    // The architecture search already reduces the space to a few thousand
    // coherent 12/6 candidates. Every generated candidate is scored and ranked;
    // item/turn validation only produces warnings and never deletes a build.
