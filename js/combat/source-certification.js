...
function normalizeEvidence(evidence = [], spellId = '') {
...
export function createPlannerSourceCertification({
  ...
  const normalizedEvidence = normalizeEvidence(evidence, id);
...
export function validatePlannerSourceCertification(spellId, sourceCertification = null) {
  ...
  const evidence = normalizeEvidence(certification.evidence || [], id);
