const CACHE = 'dofus-optimizer-v0.7.4';
const APP_SHELL = [
  ...
  './js/hard-constraint-choices.js', './js/offensive-scope.js', './js/dofus-seed-priors.js',
  './js/seed-search.js', './js/solver.js', './js/solver-worker.js', './js/sample-data.js', './js/app.js'
];
